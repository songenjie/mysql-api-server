...
func GetQueueList(w http.ResponseWriter, r *http.Request) {
	...
	if v.Get("martProduction") == "" {
		re.Message = "martProduction Name  Cannot is null!"
		return
	}
	...
	pe := dal.GetProductionList(&re, *dal.Username, me.Clustercode, me.Martcode, v.Get("martName"), v.Get("martProduction"), false)

	dal.GetQueueList(&re, *dal.Username, me.Clustercode, me.Martcode, v.Get("martName"), v.Get("martProduction"), pe.ProductionAccountCode, pe.BuinessLine)
